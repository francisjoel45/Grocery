...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Grocery.context_processors.role_flags',
            ],
        },
    },
]
...
LOGIN_URL = 'Grocery:login'  # Updated with app namespace
LOGIN_REDIRECT_URL = 'Grocery:dashboard'  # Updated with app namespace
LOGOUT_REDIRECT_URL = 'Grocery:login'  # Updated with app namespace
